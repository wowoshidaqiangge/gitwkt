  ...
  <div class="detailsProduct2">
    ...
    <div class="detailcon">
        <div style="margin-bottom:15px">
            <div style="padding:0 0 10px 20px;font-weight:600;font-size:15px">零件基本信息</div>
            <div class="infolist">
      ...
      detailclose(num){
        ...
        handledit(info){
             ...
             if(info.workprocessType==5&&info.workprocessName==='完工'){
                this.$refs.detailModal.enterinfo(info,1,this.wayinfo)
            }else{
                this.$refs.detailModal.enterinfo(info,1,this.wayinfo,2)
            }
