<template>
  <div class="chartContent">
    <div class="chart" id="barLineProduct"></div>
  </div>
</template>
<script>
import { produceComplete } from '@/api/globalPage';
    ...
    barLineProductFunc() {
      produceComplete()
        .then(res => {
          ...
          let myChart = echarts.init(document.getElementById('barLineProduct'));
          let option = {
            color: ['#00B7EE', '#F19149'],
            textStyle: {
              color: '#fff'
