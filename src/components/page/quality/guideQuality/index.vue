<template>
  <div class="guideQuality">
       <div v-if="!isdetails">
           <div class="top">
                    <el-form :model="seachinfo"  ref="seachinfo"  class="demo-ruleForm">
                    <el-row type='flex' justify="end">
                        <div style="flex:1">
                            <el-button type="add" icon='el-icon-circle-plus-outline' @click="add">质检配置</el-button>
                        </div>
                        <el-col :span="5">
                        ...
                        <el-col :span="3">
                            <el-form-item label=""  prop="itemNameOrCode" >
                                <el-input  placeholder="请输入物料名称或编码" v-model="seachinfo.itemNameOrCode" class="elinput"> </el-input>
                            </el-form-item>
                        </el-col>
     ...
     <Detailsproduct v-if="isdetails" @backpro="backpro" :isdaogui="isdaogui" ref="proDetails"/>
    <Modal :dialogFormVisible="dialogFormVisible" :tit="tit" @close='close'/>
  </div>
</template>
