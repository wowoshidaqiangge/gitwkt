<template>
  <div class="metaexcel">
    <el-dialog :title="tit" :destroy-on-close='isclose' :visible.sync="dialogFormVisible1" width='40%'
      ...
      <el-row>
        ...
        <div>
          ...
          <p class="login-tips">说明: 导入文件类型必须为excel格式，你可以先点击 <a
              href="https://thingcom-test.oss-cn-hangzhou.aliyuncs.com/%E5%A8%81%E8%82%AF%E7%89%B9-%E8%AE%BE%E5%A4%87%E6%A1%A3%E6%A1%88-%E6%A8%A1%E6%9D%BF.xlsx">下载模板</a>。
          </p>
        </div>
      </el-row>
    </el-dialog>
