    ...
    <el-dialog :title="title" :visible="dialogRawVisible" id="myDialog" width="50%" :before-close="beforeClose" center>
      <el-form class="myForm flex" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px">
        <el-form-item label="物料编码" prop="materialCode">
          <el-input v-model="ruleForm.materialCode" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="物料图号" prop="materialNumber">
          <el-input v-model="ruleForm.materialNumber" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="物料名称" prop="materialName">
          <el-input v-model="ruleForm.materialName" placeholder=""></el-input>
        </el-form-item>
...
import { addRaw, putRaw } from '@/api/permanagement/material';
export default {
  name: 'rawModal',
  props: {
    dialogRawVisible: {
