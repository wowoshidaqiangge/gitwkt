      ...
      <div class="bot">
        <el-table :data="tableData" border="" stripe style="width: 100%">
          ...
          <el-table-column label="操作" width="100" align="center">
            <template slot-scope="scope">
              <el-button v-if="scope.row.state != 6" type="add" plain @click="handleDetails(scope.$index, scope.row)">派单
              </el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      let obj = { ...this.seachinfo, ...this.page, type: '1', beginDate: this.dateValue[0], endDate: this.dateValue[1] };
