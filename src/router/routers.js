const routes = [
  ...
  // 大屏
  {
    ...
    component: () => import('../components/page/globalPage/index.vue'),
    meta: { title: '一部大屏' }
  },
  {
    path: '/bigscreensecond',
    /* webpackChunkName: "dashboard" */
    component: () => import('../components/page/globalPage2/index.vue'),
    meta: { title: '二部大屏' }
  },

  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "dashboard" */
        '../components/page/globalPage/valvePage/index.vue'
      ),
    meta: { title: '方圆大屏参考' }
  },
